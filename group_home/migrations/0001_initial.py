# Generated by Django 5.2 on 2026-01-26 13:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('target_goal_no', models.IntegerField(blank=True, null=True)),
        ...
        migrations.AddField(
            ...
            name='resident',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='daily_records', to='group_home.resident'),
        ),
        migrations.CreateModel(
            name='ResidentOffice',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='有効フラグ')),
                ('support_plan', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='revisions', to='group_home.supportplan')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('support_plan_revision', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='monitorings', to='group_home.supportplanrevision', verbose_name='対象計画リビジョン')),
            ],
            options={
                'verbose_name': 'モニタリング',
